		...
		$(this).find('.nectar_hotspot_wrap').each(function(i){
			...
			if($(window).width() > 690) {
				...
				if($tipOffset.left > $(this).parents('.nectar_image_with_hotspots').width() - 200)
					//pale $(this).find('.nttip').css('width','250px');					$(this).find('.nttip').css('width','100%');				else
				...
				if($tipOffset.left < 0)
					...
					//pale $(this).find('.nttip').addClass('force-left').css('width','250px');					$(this).find('.nttip').addClass('force-left').css('width','100%');				else if($tipOffset.top + $(this).find('.nttip').height() + 35 > $(window).height() && $('#nectar_fullscreen_rows').length > 0)

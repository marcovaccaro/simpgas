...
jQuery(document).ready(function($){
	...
	if(typeof google === 'object' && typeof google.maps === 'object') {
 		...
 		if(nectarLove.mapApiKey.length > 0) {
 			//pale $.getScript('https://maps.google.com/maps/api/js?sensor=false&key='+nectarLove.mapApiKey+'&callback=mapAPI_Loaded'); 			$.getScript('https://maps.googleapis.com/maps/api/js?sensor=false&key='+nectarLove.mapApiKey+'&callback=mapAPI_Loaded'); 		} else {
 			//pale $.getScript('https://maps.google.com/maps/api/js?sensor=false&callback=mapAPI_Loaded'); 			$.getScript('https://maps.googleapis.com/maps/api/js?sensor=false&callback=mapAPI_Loaded'); 		}
